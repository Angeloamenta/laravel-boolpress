    ...
    <div class="row">
      <div class="col">
        ...
        <form enctype="multipart/form-data">
          <div class="row mt-3">
            <div class="col">
              <!-- il v-model serve ad inviare il valore, mentre il "." indica oggetto e dentro la key -->
          ...
          <div class="row mt-3">
            <div class="col">
              <div class="mb-3">
                ...
                <!-- con @change="setFile($event.target.files) riesco a salvare il file caricato -->
                <input class="form-control" type="file" id="file" name="file" @change="setFile($event.target.files)">
              </div>
            </div>
          </div>
          <!-- il prevent serve per evitare il refresh della pagina -->
...
import Axios from "axios";
  ...
  export default {
    ...
    methods: {
      setFile(value) {
        console.log(value);
        // con questo mando il file nel form dentro data
      ...
      sendMessage() {
          ...
          //con append aggiungo a formData

          //questa funzione serve ad inviare il messaggio con il token giusto
        const headers = { 
